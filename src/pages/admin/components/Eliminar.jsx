        ...
        <div className="z-10 top-0 left-0 w-screen h-screen fixed bg-black/50 flex items-center justify-center">
            <div className="bg-white rounded-lg shadow-lg p-8 w-[90%] max-w-md">
                ...
                <div className="flex gap-3 mt-6">
                    <button className="flex-1 px-4 py-2 bg-gray-300 text-black rounded-lg hover:bg-gray-400 transition-colors font-semibold cursor-pointer " onClick={setDelete}>
                        Cancelar
                    </button>
                    <button className="flex-1 px-4 py-2 bg-black text-white rounded-lg transition-colors font-semibold cursor-pointer" onClick={setDelete}>
                        Eliminar
                    </button>
                </div>
            </div>
